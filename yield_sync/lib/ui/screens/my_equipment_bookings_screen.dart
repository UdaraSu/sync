...
class MyEquipmentBookingsScreen extends StatelessWidget {
  ...
  static void _showOwnerDialog(BuildContext context, Map<String, dynamic> booking) {
                  ...
                  builder: (context, snap) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, i) {
                        ...
                        final equipmentId = (m["equipmentId"] ?? "").toString();
                        ...
                        return Padding(
                          ...
                          child: _BookingCard(
                            ...
                            onCancel: status == "pending"
                                ? () async {
                                    await EquipmentBookingService.updateStatus(
                                      bookingId: d.id,
                                      status: "cancelled",
                                    );
                                  }
